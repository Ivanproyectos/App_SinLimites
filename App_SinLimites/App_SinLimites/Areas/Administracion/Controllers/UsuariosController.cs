...
namespace App_SinLimites.Areas.Administracion.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Mantenimiento(int id, string Accion)
        {
            ...
            using (CombosRepositorio RepositorioPerfil = new CombosRepositorio())
            {

                model.Lista_Perfil = RepositorioPerfil.Perfil_Listar( ref auditoria).Select(x => new SelectListItem()
                {
                    Text = x.DESC_PERFIL,
